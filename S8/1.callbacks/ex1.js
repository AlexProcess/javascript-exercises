...
//La función subact hará lo mismo pero restandstro y la función father recibirá como parámetros a, b y una función callback (sum o substract).
...
function father(a, b, callbackPepito){
    let result = callbackPepito(a, b);
